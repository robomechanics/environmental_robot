...
class EndEffectorTrajectory:
    ...
    def get_touchdown_waypoints(self):
        ...
        pos[:, 0] = [4.7667532, 2.01732284, -1.83409595, -0.66559677]
        pos[:, 1] = [4.70845413, 2.87031967, -1.8154192, 0.439913826]
    ...
    def get_hebi_trajectory(self, waypoints, total_duration):
    ...
    def arm_touchdown(self):
        ...
        waypoints_forward = self.get_forward_waypoints()
        self.get_hebi_trajectory(waypoints_forward, 4)
        self.execute_trajectory_with_efforts()
        waypoints = self.get_touchdown_waypoints()
        self.get_hebi_trajectory(waypoints, 10)
        self.execute_trajectory_with_efforts()
    ...
    def arm_return(self):
        ...
        self.get_hebi_trajectory(waypoints, 8)
        self.execute_trajectory()
